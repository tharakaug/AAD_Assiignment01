...
<head>
    ...
    <!--
      - custom css link
    -->
    <link rel="stylesheet" href="assets/css/babyCare.css">
...
<ul class="has-scrollbar">
    ...
    <li class="scrollbar-item">
        <div class="shop-card">
            ...
            <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                <img src="./assets/images/b1.jpg" width="540" height="720" loading="lazy"
            ...
            <div class="card-content">
                ...
                <h3>
                    <a href="#" class="card-title">Aromaweda Baby Oil</a>
                </h3>
    ...
    <li class="scrollbar-item">
        <div class="shop-card">
            ...
            <div class="card-content">
                ...
                <div class="price">
                    <span class="span">Rs 4500</span>
                </div>

                <h3>
                    <a href="#" class="card-title">Baby Body Cream</a>
                </h3>
    ...
    <li class="scrollbar-item">
        <div class="shop-card">
            ...
            <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                <img src="./assets/images/b5.webp" width="540" height="720" loading="lazy"
                     alt="Coffee Bean Caffeine Eye Cream" class="img-cover">
            ...
            <div class="card-content">
                ...
                <h3>
                    <a href="#" class="card-title">Baby Smoothy Oil</a>
                </h3>
    ...
    <li class="scrollbar-item">
        <div class="shop-card">
            ...
            <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                <img src="./assets/images/b6.webp" width="540" height="720" loading="lazy"
                     alt="Facial cleanser" class="img-cover">
            ...
            <div class="card-content">
                ...
                <h3>
                    <a href="#" class="card-title">Baby Hand Cream</a>
                </h3>
